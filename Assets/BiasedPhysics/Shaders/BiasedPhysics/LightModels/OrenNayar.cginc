...
half3 BiasedPhysics_OrenNayar_SampledIBL(SurfaceOutput surface, half3 worldViewDir, half3 worldNormal, sampler2D encodedSamples, int sampleCount) {
    ...
    for (int i = 0; i < sampleCount; ++i) {
        ...
        iblColor += SampleOrenNayerIBL(sampleUV, worldViewDir, worldNormal, tangent, bitangent, _Roughness, _GlobalEnvironment);
    }
