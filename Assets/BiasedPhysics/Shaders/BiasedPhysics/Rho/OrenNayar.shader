...
//==============================================================================
Shader "BiasedPhysics/Rho/OrenNayar" {
	Properties {
    ...
    Subshader {
        Pass {
            ...
            half4 frag(v2f i) : COLOR {
                ...
                // Since OrenNayar is isotropic we are free to choose x and z as we
                ...
                for (int i = 0; i < _SamplesDrawn; ++i) {
                    ...
                    BxDFSample bxdfSample = SampleOrenNayar(sampleUV, viewDir, normal, tangent, bitangent, roughness);
